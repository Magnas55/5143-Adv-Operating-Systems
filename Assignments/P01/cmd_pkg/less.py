...
def less(params=None):
    """ DESCRIPTION: The `less` command provides a way to view the contents of a file one page at a time.
       
       USAGE: less [FILE]

       EXAMPLE:
           > less file1.txt
           Displays the content of file1.txt, paginated.
    ...
    if response["status"] == "success":
        ...
        num_pages = (len(lines) + page_size - 1) // page_size  # Calculate the number of pages
